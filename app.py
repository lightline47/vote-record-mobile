...
# BUILD: vote-record-mobile v5.48 REPORT-PAGE1-STRUCTURE-CLEANUP 2026-08-25
...
with title_col_v50:
    st.markdown(
        '<div class="app-main-title-v33">🗳️ 투표록 작성 보조 앱 — <span class="mobile-version-v51">모바일 전용 v5.48</span></div>',
        unsafe_allow_html=True,
    )
...
if workflow_step == "②[보고]투표진행상황":
    with workflow_cluster_v59:
        st.markdown(
            f"""
            <div class="report-page2-shell-v548">
                {selected_station_confirm_html_v530}
                <div class="report-gap-after-confirm-v548"></div>
                <div class="report-page2-title-v548">
                    <span class="report-page2-title-green-v548">②[보고]</span> 투표진행상황
                </div>
                <div class="report-gap-after-title-v548"></div>
                <div class="report-page2-subtitle-v548">1.투표진행상황 보고(투표용지 교부수량 산출)</div>
            </div>
            """,
            unsafe_allow_html=True,
        )
