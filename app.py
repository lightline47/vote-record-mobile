...
title_col_v50, admin_title_col_v50, _title_spacer_v50 = st.columns([5.4, 0.9, 3.7], gap="small")
with title_col_v50:
    st.markdown(
        '<div class="app-main-title-v33">🗳️ 투표록 작성 보조 앱 — <span class="mobile-version-v51">모바일 전용 v5.2</span></div>',
        unsafe_allow_html=True,
    )
