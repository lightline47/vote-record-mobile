...
# BUILD: vote-record-mobile FINAL v3.6 SINGLEBUTTON 2026-08-24
...
st.markdown(
    '<div class="app-main-title-v33">🗳️ 투표록 작성 보조 앱 — 모바일 전용 v3.6</div>',
    unsafe_allow_html=True,
)
st.markdown(
...
st.markdown(
    ...
    [class*="st-key-navcard_"] button {
        ...
        background: #ffffff !important;
        box-shadow: none !important;
        padding: 8px 8px 8px 118px !important;
        overflow: visible !important;
    }
    ...
    @media (max-width: 900px) {
        ...
        [class*="st-key-navcard_"] button p {font-size: 12px !important;}
        .st-key-navcard_select_v35 button::after,
        .st-key-navcard_report_v35 button::after,
        .st-key-navcard_input_v35 button::after,
        .st-key-navcard_reference_v35 button::after {
        ...
        [class*="st-key-navcard_"] button::before {left: 9px; font-size:20px;}
        .nav-arrow-v35 {font-size:24px; min-height:64px;}
    }
    </style>
    """,
    unsafe_allow_html=True,
...
c1, a1, c2, a2, c3, a3, c4 = st.columns([1.20, .14, 1.62, .14, 1.62, .14, 1.62], gap="small")
with c1:
