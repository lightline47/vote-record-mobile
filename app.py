...
# BUILD: vote-record-mobile v5.55 ELEMENT-CONTAINER-SPACING-FIX 2026-08-25
...
with title_col_v50:
    st.markdown(
        '<div class="app-main-title-v33">🗳️ 투표록 작성 보조 앱 — <span class="mobile-version-v51">모바일 전용 v5.55</span></div>',
        unsafe_allow_html=True,
    )
