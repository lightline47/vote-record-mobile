...
# BUILD: vote-record-mobile v5.50 REPORT-TOP-SINGLE-BLOCK 2026-08-25
...
with title_col_v50:
    st.markdown(
        '<div class="app-main-title-v33">🗳️ 투표록 작성 보조 앱 — <span class="mobile-version-v51">모바일 전용 v5.50</span></div>',
        unsafe_allow_html=True,
    )
...
if workflow_step == "②[보고]투표진행상황":
    with workflow_cluster_v59:
        # v5.50: ②페이지 상단을 하나의 HTML 블록으로 구성.
        # 공용 gap 클래스와 Streamlit 요소 사이 자동 간격의 영향을 받지 않도록 함.
        st.markdown(
            f"""
            <div class="report-top-shell-v550">
                {selected_station_confirm_html_v530}
                <div class="report-confirm-gap-v550"></div>
                <div class="report-title-v550">
                    <span class="report-title-green-v550">②[보고]</span> 투표진행상황
                </div>
                <div class="report-title-gap-v550"></div>
                <div class="report-subtitle-v550">1.투표진행상황 보고(투표용지 교부수량 산출)</div>
            </div>
            """,
            unsafe_allow_html=True,
        )
