            ...
            if not db or station is None:
                ...
                with st.container(border=True, key="report_input_calc_box"):
                    for i, e in enumerate(report_elections):
                        ...
                        st.markdown(
                            f'<div class="report-v41-label-red report-input-label-v557">[입력] <span class="report-v41-election">{e["name"]}</span><br>'
                            '잔여투표용지 첫 번호(NO.)</div>',
                            unsafe_allow_html=True,
                        )
                        ...
                        st.markdown(
                            ...
                            '<span class="report-help-line-v560">보고대상 선거의 현재 남아 있는 <span class="red">투표용지 첫 번호(NO.)를 [입력]란에</span></span>'
                            '<span class="report-help-line-v560">기재 후 지금까지 <span class="blue">교부된 투표용지 수량을 산출</span>하여 보고합니다.</span>'
                            '</span>'
                            '</div>',
                            unsafe_allow_html=True,
                        )
