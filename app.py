...
# BUILD: vote-record-mobile v5.46 REPORT-EXACT-PAGE1-STRUCTURE 2026-08-25
...
with title_col_v50:
    st.markdown(
        '<div class="app-main-title-v33">🗳️ 투표록 작성 보조 앱 — <span class="mobile-version-v51">모바일 전용 v5.46</span></div>',
        unsafe_allow_html=True,
    )
...
if workflow_step == "②[보고]투표진행상황":
    with workflow_cluster_v59:
        st.markdown(
            f"""
            <div class="step1-fixed-layout-v531 report-page2-fixed-v546">
                {selected_station_confirm_html_v530}
                <div class="confirm-to-title-gap-v531"></div>
