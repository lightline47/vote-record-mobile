...
# BUILD: vote-record-mobile v5.16 SELECT-SPACING-FINAL 2026-08-25
...
with title_col_v50:
    st.markdown(
        '<div class="app-main-title-v33">🗳️ 투표록 작성 보조 앱 — <span class="mobile-version-v51">모바일 전용 v5.16</span></div>',
        unsafe_allow_html=True,
    )
...
with workflow_cluster_v59:
    ...
    # v5.15: 상단 진행영역과 각 단계 본문을 화면 끝까지 이어지는 선으로 구분
    st.markdown('<div class="station-section-divider-v515"></div>', unsafe_allow_html=True)
                ...
                <div class="select-instruction-v514">
                    <span class="tap-icon-v515" aria-hidden="true">
                        <svg viewBox="0 0 64 64" role="img">
                            <circle cx="25" cy="16" r="9" fill="none" stroke="#2f80ed" stroke-width="3"/>
                            <circle cx="25" cy="16" r="4" fill="#2f80ed"/>
                            <path d="M25 20v20M25 29l-5-5c-2-2-5-2-7 0-2 2-2 5 0 7l12 15c3 4 7 6 12 6h5c6 0 11-5 11-11V29c0-3-2-5-5-5-2 0-4 1-5 3-1-3-3-5-6-5-2 0-4 1-5 3-1-3-3-5-6-5-1 0-2 0-3 1"
                                  fill="#fff2d8" stroke="#1f2937" stroke-width="2.5"
                                  stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </span>
                    <span class="select-guide-text-v515">먼저, 해당 <span class="select-keyword-v515">'동'</span>과 <span class="select-keyword-v515">'투표소'</span>를 선택하세요!</span>
                </div>
            </div>
            """,
            unsafe_allow_html=True,
