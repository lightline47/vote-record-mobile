...
if workflow_step == "②[보고]투표진행상황":
                    ...
                    for i, e in enumerate(report_elections):
                        ...
                        if raw.strip():
                            if n is None:
                                ...
                                invalid_input = True
                                errors.append(f"{report_target_name}: 허용범위 {e['start_no']:,} ~ {e['end_no']+1:,}")
                            else:
    ...
    if not st.session_state.admin_authenticated:
        with st.form("admin_login_form_v584", clear_on_submit=False):
        ...
        st.caption("②[보고] 투표진행상황 화면에 표시할 보고용 선거명을 입력합니다.")
        ...
        report_name_input = st.text_input(
            ...
            on_change=save_report_name_from_widget,
        )
