...
title_col_v50, admin_title_col_v50, _title_spacer_v50 = st.columns([5.3, 0.9, 3.8], gap="small")
with title_col_v50:
    st.markdown(
        '<div class="app-main-title-v33">🗳️ 투표록 작성 보조 앱 — <span class="mobile-version-v50">모바일 전용 v5.0</span></div>',
        unsafe_allow_html=True,
    )
with admin_title_col_v50:
    st.button("[관리자]", key="title_admin_v50", on_click=lambda: st.session_state.update(workflow_step_v33="admin"), width="stretch")
st.markdown(
...
st.markdown(
    ...
    .mobile-version-v50 {font-size:calc(1em - 4px) !important;}
    /* 제목 옆 관리자 버튼: 목록에서는 제거하고 여기서만 선택 */
    .st-key-title_admin_v50 button {
        border:none !important; background:transparent !important; box-shadow:none !important;
        min-height:34px !important; height:34px !important; padding:0 2px !important; margin-top:5px !important;
    }
    .st-key-title_admin_v50 button p {color:#111 !important; font-weight:900 !important; font-size:16px !important; white-space:nowrap !important;}
    ...
    @media (max-width:900px) {
        .st-key-title_admin_v50 button p {font-size:13px !important;}
