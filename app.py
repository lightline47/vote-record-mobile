...
# BUILD: vote-record-mobile v5.40 REPORT-IN-WORKFLOW-CONTAINER 2026-08-25
...
with title_col_v50:
    st.markdown(
        '<div class="app-main-title-v33">🗳️ 투표록 작성 보조 앱 — <span class="mobile-version-v51">모바일 전용 v5.40</span></div>',
        unsafe_allow_html=True,
    )
...
if workflow_step == "②[보고]투표진행상황":
    with workflow_cluster_v59:
        st.markdown(
            '<div class="report-screen-heading-v539"><span class="report-title-green-v539">②[보고]</span> 투표진행상황</div>',
            unsafe_allow_html=True,
        )
