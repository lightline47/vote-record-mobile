        ...
        with st.container(key="report_body_v551"):
            ...
            if not db or station is None:
                ...
                st.markdown(
                    ...
                    '<thead><tr><th>선거명</th><th>수령매수</th><th>시작번호</th><th>끝번호</th></tr></thead>'
...
st.markdown(
    ...
    .report-v41-table col.col-election { width: 38% !important; }
    .report-v41-table col.col-count,
    .report-v41-table col.col-start,
    .report-v41-table col.col-end { width: 20.666% !important; }
    .report-v41-table th,
    .report-v41-table td {
        white-space: normal !important;
        word-break: keep-all !important;
    ...
    .st-key-title_admin_v52 button {
        background-size: calc(100% + 3px) auto !important;
        overflow: visible !important;
    }
