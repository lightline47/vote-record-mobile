...
# ============================================================
# 2026-09-15 메뉴 검정 글자 복구 안정화
# - 검정 메뉴명이 정상 표시되던 직전 버전을 기준으로 유지
# - ② 투표진행상황은 마지막 글자 잘림 방지를 위해 1px 왼쪽 이동
# - 현재접속중 표시는 확인상자 바로 아래쪽으로 소폭 상향
# ============================================================
st.markdown(
    r"""
    <style>
...
# ============================================================
# 2026-09-15 ②[보고] 검정 메뉴명 강제 복구
# - 모바일에서 두 번째 카드의 실제 버튼 문구가 CSS 충돌로 사라지는 현상 방지
# - 초록색 ②[보고]는 기존 ::after 유지
# - 검정색 '투표진행상황'은 p::before로 명시적으로 렌더링
# ============================================================
st.markdown(
    r"""
    <style>
    @media (max-width: 768px) {
        ...
        .st-key-workflow_cluster_v59 .st-key-navcard_report_v35 button p::before {
            content: "투표진행상황" !important;
            display: inline-block !important;
            color: #111 !important;
            font-size: 12.2px !important;
            font-weight: 900 !important;
