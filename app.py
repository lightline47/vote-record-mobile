...
title_col_v50, admin_title_col_v50, _title_spacer_v50 = st.columns([7.0, 0.9, 2.1], gap="small")
with title_col_v50:
    st.markdown(
        '<div class="app-main-title-v33">🗳️ 투표록 작성 보조 앱 — <span class="mobile-version-v51">모바일 전용 v5.1</span></div>',
        unsafe_allow_html=True,
    )
with admin_title_col_v50:
    st.button("[관리자]", key="title_admin_v51", on_click=lambda: st.session_state.update(workflow_step_v33="admin"), width="stretch")
st.markdown(
...
st.markdown(
    ...
    .st-key-title_admin_v51 button p {color:#111 !important; font-weight:900 !important; font-size:16px !important; white-space:nowrap !important;}
    ...
    @media (max-width:900px) {
        .st-key-title_admin_v51 button p {font-size:13px !important;}
...
st.markdown(
    ...
    .st-key-title_admin_v51 button p {color:#111 !important; font-size:14px !important; font-weight:900 !important;}

    /* 반드시 안내와 네비게이션 카드 사이를 최대한 밀착 */
    div[data-testid="stMarkdownContainer"]:has(.workflow-guide-v33) {margin-bottom:-92px !important; padding-bottom:0 !important;}
    div[data-testid="stHorizontalBlock"]:has(.st-key-navcard_select_v35) {margin-top:-78px !important; padding-top:0 !important;}
    ...
    @media (max-width:900px) {
        ...
        .st-key-title_admin_v51 button p {font-size:11px !important;}
        div[data-testid="stMarkdownContainer"]:has(.workflow-guide-v33) {margin-bottom:-88px !important;}
        div[data-testid="stHorizontalBlock"]:has(.st-key-navcard_select_v35) {margin-top:-74px !important;}
