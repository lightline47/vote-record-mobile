...
# BUILD: vote-record-mobile FINAL v4.8 CONSOLIDATED-UI 2026-08-24
...
st.markdown(
    '<div class="app-main-title-v33">🗳️ 투표록 작성 보조 앱 — 모바일 전용 v4.8</div>',
    unsafe_allow_html=True,
)
st.markdown(
...
if workflow_step == "①[선택]투표소":
        ...
        with st.container(border=True, key="station_choice_input_box"):
            ...
            with c1:
                st.markdown(
                    ...
                    '<span class="hint">(아래 콤보박스에서 <span class="em">해당 동 선택</span>)</span></div>',
                    unsafe_allow_html=True,
                )
            ...
            with c2:
                st.markdown(
                    ...
                    '<span class="hint">(아래 콤보박스에서 <span class="em">해당 투표소 선택</span>)</span></div>',
                    unsafe_allow_html=True,
                )
    ...
    if not db or station is None:
        ...
        st.markdown(
            '<div class="report-v41-headrow"><span class="report-v41-title">1. 투표진행상황 보고</span></div>',
            unsafe_allow_html=True,
        )
