...
# BUILD: vote-record-mobile v5.30 STEP1-SINGLE-BLOCK 2026-08-25
...
with title_col_v50:
    st.markdown(
        '<div class="app-main-title-v33">🗳️ 투표록 작성 보조 앱 — <span class="mobile-version-v51">모바일 전용 v5.30</span></div>',
        unsafe_allow_html=True,
    )
...
if workflow_step == "①[선택]투표소":
    with st.container(key="selection_body_v530"):
        # ① 화면은 확인상자 → 10px → 제목/안내를 한 HTML 블록으로 묶어
        # Streamlit 외부 컨테이너 gap이 끼어들지 않도록 함.
        st.markdown(
            f"""
            <div class="step1-fixed-layout-v530">
                {selected_station_confirm_html_v530}
                <div class="confirm-to-title-gap-v530"></div>
                <div class="station-select-title-v530"><span class="select-title-green">①[선택]</span> 투표소</div>
                <div class="select-instruction-v530">
                    <span class="tap-finger-v530" aria-hidden="true">👆</span>
                    <span class="select-guide-text-v530">해당 <span class="select-keyword-v530">'동'</span>과 <span class="select-keyword-v530">'투표소'</span>를 선택하세요!</span>
                </div>
            </div>
            """,
            unsafe_allow_html=True,
...
st.markdown(
    ...
    .st-key-selection_body_v530 {
        margin: 0 !important;
        padding: 0 !important;
    }
    .st-key-selection_body_v530 > div[data-testid="stVerticalBlock"] {
        gap: 0 !important;
        row-gap: 0 !important;
        margin: 0 !important;
        padding: 0 !important;
    }
    .st-key-selection_body_v530 > div[data-testid="stVerticalBlock"] > div[data-testid="stElementContainer"] {
        margin: 0 !important;
        padding: 0 !important;
    }

    /* ① 화면 첫 블록 전체 */
    .step1-fixed-layout-v530 {
        margin: 0 !important;
        padding: 0 !important;
    }

    /* 확인상자 자체는 하단 margin 0 */
    .step1-fixed-layout-v530 .shared-station-confirm {
        margin: 0 !important;
    }

    /* 요청한 실제 10px 빈 공간 */
    .confirm-to-title-gap-v530 {
        display: block !important;
        height: 10px !important;
    ...
    .station-select-title-v530 .select-title-green {
        color: #00a83b !important;
        font-weight: 950 !important;
    }

    /* 안내문 */
    .select-instruction-v530 {
        display: flex !important;
        align-items: center !important;
        gap: 6px !important;
        margin: 0 !important;
    ...
    /* 안내문 다음 선택상자: 실제 2px */
    .st-key-selection_body_v530 .st-key-station_choice_input_box {
        margin-top: 2px !important;
        padding-top: 6px !important;
    }

    /* 보라색 상자 라벨은 잘리지 않게 */
    .st-key-selection_body_v530 .station-choice-label {
        line-height: 1.25 !important;
        min-height: 1.3em !important;
        overflow: visible !important;
        margin: 0 0 5px 0 !important;
