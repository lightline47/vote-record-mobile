...
# BUILD: vote-record-mobile v5.26 CENTER-SPACER-HAND-GAP 2026-08-25
...
with title_col_v50:
    st.markdown(
        '<div class="app-main-title-v33">🗳️ 투표록 작성 보조 앱 — <span class="mobile-version-v51">모바일 전용 v5.26</span></div>',
        unsafe_allow_html=True,
    )
...
with workflow_cluster_v59:
    ...
    st.markdown('<div class="workflow-progress-arrow-v518"></div>', unsafe_allow_html=True)
...
with workflow_cluster_v59:
    if station is not None:
        st.markdown(
            f'<div class="selected-station-confirm shared-station-confirm"><span class="confirm-check-v524">☑</span>'
            f'선택한 투표소는 <span class="selected-name">({station["dong"]} {station["station"]}표소)</span>입니다.</div>',
            unsafe_allow_html=True,
        )
    else:
        st.markdown(
            '<div class="selected-station-confirm shared-station-confirm"><span class="confirm-check-v524">☑</span>'
        ...
        st.markdown('<div class="after-confirm-spacer-v526"></div>', unsafe_allow_html=True)
        ...
        st.markdown(
            ...
            <div class="select-screen-heading-v514">
                ...
                <div class="select-instruction-v514">
                    <span class="tap-icon-v515" aria-hidden="true">
                        <svg viewBox="0 0 64 64" role="img">
                            <circle cx="20" cy="11" r="8" fill="none" stroke="#2f80ed" stroke-width="3"/>
                            <circle cx="20" cy="11" r="3" fill="#2f80ed"/>
                            <path d="M20 14 L20 39
                                     M20 27 L15 23
                                     C12 21 9 23 9 26
                                     C9 27 10 29 11 30
                                     L22 45
                                     ...
                                     C24 12 22 10 20 10
                                     C18 10 16 12 16 15"
                                  fill="#fff2d8" stroke="#222" stroke-width="2.6"
                                  stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </span>
                    <span class="select-guide-text-v515">해당 <span class="select-keyword-v515">'동'</span>과 <span class="select-keyword-v515">'투표소'</span>를 선택하세요!</span>
                </div>
            </div>
            """,
            unsafe_allow_html=True,
