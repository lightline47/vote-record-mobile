...
# BUILD: vote-record-mobile FINAL v4.4 INPUT-COMBO 2026-08-24
...
st.markdown(
    '<div class="app-main-title-v33">🗳️ 투표록 작성 보조 앱 — 모바일 전용 v4.4</div>',
    unsafe_allow_html=True,
)
st.markdown(
...
if workflow_step == "①[선택]투표소":
    ...
    if not db:
        ...
        # 아. 관련 기초자료 입력 — 먼저 배치
        # ----------------------------------------------------
        st.markdown("### 투표상황 기초자료 입력(투표록 2p/아. 관련)")
        st.caption(
        ...
        # ----------------------------------------------------
        st.markdown("### 투표용지 수령 교부상황 기초자료 입력(투표록 2p/자. 관련)")
        st.caption(
