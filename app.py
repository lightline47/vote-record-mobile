...
# BUILD: vote-record-mobile v5.44 REPORT-SPACING-HIGHLIGHT-HELP 2026-08-25
...
with title_col_v50:
    st.markdown(
        '<div class="app-main-title-v33">🗳️ 투표록 작성 보조 앱 — <span class="mobile-version-v51">모바일 전용 v5.44</span></div>',
        unsafe_allow_html=True,
    )
...
if workflow_step == "②[보고]투표진행상황":
    with workflow_cluster_v59:
        st.markdown(
            f"""
            <div class="report-fixed-layout-v544">
                {selected_station_confirm_html_v530}
                <div class="confirm-to-title-gap-v531"></div>
                <div class="report-screen-heading-v544"><span class="report-title-green-v544">②[보고]</span> 투표진행상황</div>
            </div>
            """,
            unsafe_allow_html=True,
        )
                ...
                for i, e in enumerate(report_elections):
                    ...
                    with c2:
                        ...
                        st.markdown(
                            ...
                            '<div class="report-v41-label-blue">[보고]<br>교부수량</div>'
