...
# BUILD: vote-record-mobile v5.29 STRUCTURAL-LAYOUT-CLEANUP 2026-08-25
...
with title_col_v50:
    st.markdown(
        '<div class="app-main-title-v33">🗳️ 투표록 작성 보조 앱 — <span class="mobile-version-v51">모바일 전용 v5.29</span></div>',
        unsafe_allow_html=True,
    )
...
if workflow_step == "①[선택]투표소":
    with st.container(key="selection_body_v527"):
        st.markdown(
            """
            <div class="select-screen-heading-v529">
                <div class="station-select-title-v50"><span class="select-title-green">①[선택]</span> 투표소</div>
                <div class="select-instruction-v529">
                    <span class="tap-finger-v529" aria-hidden="true">👆</span>
                    <span class="select-guide-text-v529">해당 <span class="select-keyword-v529">'동'</span>과 <span class="select-keyword-v529">'투표소'</span>를 선택하세요!</span>
                </div>
            </div>
            """,
            unsafe_allow_html=True,
