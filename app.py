...
with title_col_v50:
    st.markdown(
        '<div class="app-main-title-v33">🗳️ 투표록 작성 보조 앱 — <span class="mobile-version-v51">모바일 전용 v5.8</span></div>',
        unsafe_allow_html=True,
    )
...
if workflow_step == "①[선택]투표소":
    ...
    if not db:
        ...
        st.markdown(
            ...
            '<thead><tr><th>선거명</th><th>거소투표용지 미발송·반송자</th>'
            '<th>결정서 지참자</th><th>거소투표용지와 회송용봉투 반납자</th></tr></thead>'
...
# ============================================================
# v5.8 모바일 최종 보정
# - 안내문과 ①~④ 메뉴 사이 간격: 약 5mm(19px) 목표
# - 메뉴 카드 글자를 카드 폭 안에서 한 단계 더 확대
# ============================================================
st.markdown(
    r"""
    <style>
    @media (max-width: 768px) {
        /* 앞선 음수 여백 보정을 무효화하고, 실제 화면에서 약 5mm 간격을 확보 */
        div[data-testid="stMarkdownContainer"]:has(.workflow-guide-v33) {
            margin-bottom: 0 !important;
            padding-bottom: 0 !important;
        }
        ...
        .st-key-navcard_select_v35 button::after {font-size: 13px !important;}
        .st-key-navcard_select_v35 button p {font-size: 14.2px !important;}
    }
    ...
    @media (max-width: 390px) {
        ...
        .st-key-navcard_select_v35 button::after {font-size: 11.8px !important;}
        .st-key-navcard_select_v35 button p {font-size: 12.8px !important;}
    }
    </style>
    """,
    unsafe_allow_html=True,
